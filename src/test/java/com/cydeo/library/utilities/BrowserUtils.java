...
public class BrowserUtils {
    ...
    /**
     * This method will accept a dropdown as WebElement and return all options' text in a List of String
    ...
    public static void selectValueFromDropdown(WebElement dropdown, String value){
